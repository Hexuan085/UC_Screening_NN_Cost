...
line_flow_limit = np.ones((1, num_lines), dtype=float) * 3  # Upper\lower bound of line flow
...
with open('linear_data_all14_UC.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    writer.writerows(data_all)
# with open('linear_data_all14_pattern_u.csv', 'w', newline='') as f:
#     writer = csv.writer(f)
