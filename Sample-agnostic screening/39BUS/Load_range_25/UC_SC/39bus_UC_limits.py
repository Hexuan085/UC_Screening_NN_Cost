...
num_of_lines = 46   # Total amount of line
...
line_flow_limit_l = np.ones((1, num_of_lines-1), dtype=float) * 3.5  # Upper\lower bound of line flow
...
for i in range(num_samples):
    ...
    for m in range(num_of_lines):
        ...
        constraint_l_max = [q_l_max == b * x_l_max - load_l_max,
                            ...
                            load_l_max >= 0.56, load_l_max <= 0.96,  #Load region
                            cp.sum(load_l_max) == 30,
        ...
        constraint_l_min = [q_l_min == b * x_l_min - load_l_min,
                            ...
                            u_l_min <= 1, u_l_min >= 0,
                            load_l_min >= 0.56, load_l_min <= 0.96,  #Load region
                            cp.sum(load_l_min) == 30,
        ...
        constraint_l_max_bound = [q_l_max_bound == b * x_l_max_bound - load_l_max_bound,
                                  ...
                                  load_l_max_bound >= 0.56, load_l_max_bound <= 0.96,  # Load region
                                  cp.sum(load_l_max_bound) == 30,
                                  a_ln_l * q_l_max_bound >= -line_flow_limit_l.reshape(-1, ),
                                  line_flow_limit_l.reshape(-1, ) >= a_ln_l * q_l_max_bound,
                                  C * x_l_max_bound <= 45.883827,  # Cost constraint
                                  ]
        ...
        constraint_l_min_bound = [q_l_min_bound == b * x_l_min_bound - load_l_min_bound,
                                  ...
                                  load_l_min_bound >= 0.56, load_l_min_bound <= 0.96,  # Load region
                                  cp.sum(load_l_min_bound) == 30,
                                  a_ln_l * q_l_min_bound >= -line_flow_limit_l.reshape(-1, ),
                                  line_flow_limit_l.reshape(-1, ) >= a_ln_l * q_l_min_bound,
                                  C * x_l_min_bound <= 45.883827,  # Cost constraint
                                  ]
