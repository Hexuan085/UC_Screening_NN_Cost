...
for i in range(num_samples):
    ...
    load = np.random.uniform(0.5, 1.1, (num_buses, 1))
    print(np.sum(load))
    load = load * 30 / np.sum(load)

    load_bias_h = load - 1.5
    load_bias_l = load - 0.5

    if max(load_bias_h) > 0 or min(load_bias_l) < 0:
        continue
    ...
    for m in range(num_of_lines):
        ...
        constraint_l_max = [q_l_max == b * x_l_max - load_l_max,
                            ...
                            u_l_max <= 1, u_l_max >= 0,
                            load_l_max >= 0.38, load_l_max <= 1.14,
        ...
        constraint_l_min = [q_l_min == b * x_l_min - load_l_min,
                            ...
                            u_l_min <= 1, u_l_min >= 0,
                            load_l_min >= 0.38, load_l_min <= 1.14,
        ...
        constraint_l_max_bound = [q_l_max_bound == b * x_l_max_bound - load_l_max_bound,
                                  ...
                                  load_l_max_bound >= 0.38, load_l_max_bound <= 1.14,
        ...
        constraint_l_min_bound = [q_l_min_bound == b * x_l_min_bound - load_l_min_bound,
                                  ...
                                  load_l_min_bound >= 0.38, load_l_min_bound <= 1.14,
