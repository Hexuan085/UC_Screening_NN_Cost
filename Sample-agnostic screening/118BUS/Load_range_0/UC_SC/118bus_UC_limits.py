...
num_of_gen = 54  # Total amount of generator
num_buses = 118  # Total amount of bus
num_of_lines = 186  # Total amount of lines
...
for i in range(num_samples):
    ...
    for m in range(num_of_lines):
        ...
        constraint_l_max = [q_l_max == b * x_l_max - load_l_max.reshape(-1, ),
                            ...
                            u_l_max <= 1, u_l_max >= 0,
                            a_ln_l * q_l_max >= -line_flow_limit_l.reshape(-1, ),  # Relaxed integer variables
        ...
        constraint_l_max_bound = [q_l_max_bound == b * x_l_max_bound - load_l_max_bound.reshape(-1, ),
                                  ...
                                  C * x_l_max_bound <= 176.40880334370468,  # Cost constraint
                                  ]
        ...
        constraint_l_min_bound = [q_l_min_bound == b * x_l_min_bound - load_l_min_bound.reshape(-1, ),
                                  ...
                                  C * x_l_min_bound <= 176.40880334370468,  # Cost constraint
                                  ]
        ...
        if abs(l_min_bound.value) >= 3.5:
            num_con_bound[i] += 1
            sta_line_bound_min.append(m)  # Record the index of binding constraint.
            print('m', m)
